...
function StartConversationSection() {
  return (
    ...
    <div className="relative mb-8 overflow-hidden bg-white py-28">
      <div
        className="pointer-events-none absolute inset-0 opacity-[0.05]"
        style={{
          backgroundImage:
            "linear-gradient(to right, primary 1px, transparent 1px), linear-gradient(to bottom, white 1px, transparent 1px)",
          backgroundSize: "48px 48px",
        }}
      />
      <div className="pointer-events-none absolute -bottom-32 left-1/2 h-[28rem] w-[28rem] -translate-x-1/2 rounded-full bg-white/5 blur-3xl" />
      ...
      <div className="relative container flex flex-col items-center text-center">
        ...
        <h2 className="mt-5 max-w-2xl text-3xl leading-tight font-bold text-primary sm:text-4xl lg:text-[2.75rem]">
          What are you trying to make possible?
        </h2>
        ...
        <Button className="mt-9 h-12 px-7">
          Tell Us About Your Project
          <ArrowRight className="ml-1 h-4 w-4" />
        </Button>
